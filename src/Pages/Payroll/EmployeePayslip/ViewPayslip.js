...
function ViewPayslip() {
  return (
    ...
    <h5 className="mt-5">ECS CLOUD INFOTECH PVT LTD</h5>
    ...
    <div className="row mt-5 pb-3">
      ...
      <div className="col-md-6 col-12">
        <div className="row  mb-2 mt-3">
          <div className="col-6  ">
            <p className="fw-medium">Employer Name</p>
          </div>
          <div className="col-6">
            <p className="text-muted text-sm">: Nalian Sri</p>
          </div>
        </div>
      </div>
      <div className="col-md-6 col-12">
      ...
      <div className="col-md-6 col-12">
        <div className="row  mb-2 mt-3">
          <div className="col-6  ">
            <p className="fw-medium">Bank className</p>
          </div>
          <div className="col-6">
      ...
      <div className="row">
        ...
        <table className="table table-border-solid">
          <tbody>
            ...
            <tr>
              <td>In Words</td>
              <td className="text-muted text-sm">: Four Hundred Three Hundrad Twenty Dollars Only</td>
            </tr>
          </tbody>
        </table>
      </div>
