...
function ComplianceEdit() {
  ...
  const formik = useFormik({
    initialValues: {
      cmpId: "AWS",
      compComplianceDesignationName: "Finance Assistant",
      compComplianceDesignationCategory: "Permanent",
      compComplianceLeaveLimit: "8",
      compComplianceRemarks: "Good",
      compComplianceSalaryDay: "2024-04-30",
      compComplianceSalaryCalculationDay: "2024-04-29",
    },
