    ...
    const getData = async () => {
      try {
        ...
        if (response.status === 200) {
          ...
          formik.setValues({
            ...response.data,
            attendanceCheckInTime: response.data.attendanceCheckInTime
              .split("T")[1]
              .split(".")[0],
            attendanceCheckOutTime: response.data.attendanceCheckOutTime
              .split("T")[1]
              .split(".")[0],
            attendanceOtStarttime: response.data.attendanceOtStarttime
              .split("T")[1]
              .split(".")[0],
            attendanceOtEndtime: response.data.attendanceOtEndtime
              .split("T")[1]
              .split(".")[0],
