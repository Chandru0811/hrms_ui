    ...
    <div className="container-fluid">
      ...
      <div className="row mt-3">
          ...
          <div className="col-md-6 col-12 mb-3 ">
            ...
            <input
              type="date"
              className={`form-control iconInput  ${formik.touched.date && formik.errors.date ? 'is-invalid' : ''}`}
          ...
          <div className="col-md-6 col-12 mb-3 ">
            ...
            <input
              type="time"
              className={`form-control iconInput ${formik.touched.checkIn && formik.errors.checkIn ? 'is-invalid' : ''}`}
          ...
          <div className="col-md-6 col-12 mb-3 ">
            ...
            <input
              type="time"
              className={`form-control iconInput  ${formik.touched.checkOut && formik.errors.checkOut ? 'is-invalid' : ''}`}
          ...
          <div className="col-md-6 col-12 mb-3 ">
            ...
            <input
              type="time"
              className={`form-control iconInput ${formik.touched.otStarttime && formik.errors.otStarttime ? 'is-invalid' : ''}`}
          ...
          <div className="col-md-6 col-12 mb-3 ">
            ...
            <input
              type="time"
              className={`form-control iconInput  ${formik.touched.otEndtime && formik.errors.otEndtime ? 'is-invalid' : ''}`}
